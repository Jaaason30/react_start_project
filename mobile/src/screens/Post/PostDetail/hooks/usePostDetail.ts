  ...
  const fetchPostDetail = async () => {
    try {
      ...
      const newPost: PostType = {
        ...
        images: data.mediaType === 'IMAGE' ? processedImages : [],
        videoUrl: data.mediaType === 'VIDEO' && data.videoUrl ? patchUrl(data.videoUrl) : undefined,
        videoCoverUrl: data.mediaType === 'VIDEO' && data.videoCoverUrl ? patchUrl(data.videoCoverUrl) : undefined,
        videoMetadata: data.mediaType === 'VIDEO' ? data.videoMetadata : undefined,
        author: {
